...
def get_monkeys_from_str(input_str):
    ...
    for monkey_str in input_str.split('\n'):
        ...
        args = monkey_str.split(' ')[1:]
        if args[0].isnumeric():
            monkey_business = lambda a=args[0]: int(a)
        elif args[1] == '+':
            monkey_business = lambda a=args[0], b=args[2]: monkey_dict[a]() + monkey_dict[b]()
        elif args[1] == '-':
            monkey_business = lambda a=args[0], b=args[2]: monkey_dict[a]() - monkey_dict[b]()
        elif args[1] == '*':
            monkey_business = lambda a=args[0], b=args[2]: monkey_dict[a]() * monkey_dict[b]()
        ...
        monkey_dict[name] = monkey_business
    return monkey_dict
